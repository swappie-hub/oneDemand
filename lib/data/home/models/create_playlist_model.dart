...
//
//     final createPlaylistRequest = createPlaylistRequestFromJson(jsonString);
...
CreatePlaylistRequest createPlaylistRequestFromJson(String str) =>
    CreatePlaylistRequest.fromJson(json.decode(str));

String createPlaylistRequestToJson(CreatePlaylistRequest data) =>
...
CreatePlaylistResponse createPlaylistResponseFromJson(String str) =>
    CreatePlaylistResponse.fromJson(json.decode(str));

String createPlaylistResponseToJson(CreatePlaylistResponse data) =>
    json.encode(data.toJson());

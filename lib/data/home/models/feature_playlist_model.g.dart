...
_$FeaturePlaylistResponseImpl _$$FeaturePlaylistResponseImplFromJson(
        Map<String, dynamic> json) =>
    _$FeaturePlaylistResponseImpl(
      message: json['message'] as String?,
      existingVideos: (json['existingVideos'] as List<dynamic>?)
          ?.map((e) => ExistingVideo.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$$FeaturePlaylistResponseImplToJson(
        _$FeaturePlaylistResponseImpl instance) =>
    <String, dynamic>{
      'message': instance.message,
      'existingVideos': instance.existingVideos,
    };

_$ExistingVideoImpl _$$ExistingVideoImplFromJson(Map<String, dynamic> json) =>
    _$ExistingVideoImpl(
...
Map<String, dynamic> _$$ExistingVideoImplToJson(_$ExistingVideoImpl instance) =>
    <String, dynamic>{
      '_id': instance.id,
      'name': instance.name,
...
_$PersonalPlaylistRequestImpl _$$PersonalPlaylistRequestImplFromJson(
        Map<String, dynamic> json) =>
    _$PersonalPlaylistRequestImpl(
      userId: json['userId'] as String?,
    );

Map<String, dynamic> _$$PersonalPlaylistRequestImplToJson(
        _$PersonalPlaylistRequestImpl instance) =>
    <String, dynamic>{

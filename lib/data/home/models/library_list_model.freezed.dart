...
LibraryListRequest _$LibraryListRequestFromJson(Map<String, dynamic> json) {
  return _LibraryListRequest.fromJson(json);
}

/// @nodoc
mixin _$LibraryListRequest {
...
/// @nodoc
abstract class $LibraryListRequestCopyWith<$Res> {
  factory $LibraryListRequestCopyWith(
          LibraryListRequest value, $Res Function(LibraryListRequest) then) =
      _$LibraryListRequestCopyWithImpl<$Res, LibraryListRequest>;
  @useResult
  $Res call(
...
/// @nodoc
class _$LibraryListRequestCopyWithImpl<$Res, $Val extends LibraryListRequest>
    implements $LibraryListRequestCopyWith<$Res> {
  _$LibraryListRequestCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$LibraryListRequestImplCopyWith<$Res>
    implements $LibraryListRequestCopyWith<$Res> {
  factory _$$LibraryListRequestImplCopyWith(_$LibraryListRequestImpl value,
          $Res Function(_$LibraryListRequestImpl) then) =
      __$$LibraryListRequestImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "categoryId") String? categoryId,
...
/// @nodoc
class __$$LibraryListRequestImplCopyWithImpl<$Res>
    extends _$LibraryListRequestCopyWithImpl<$Res, _$LibraryListRequestImpl>
    implements _$$LibraryListRequestImplCopyWith<$Res> {
  __$$LibraryListRequestImplCopyWithImpl(_$LibraryListRequestImpl _value,
...
/// @nodoc
@JsonSerializable()
class _$LibraryListRequestImpl implements _LibraryListRequest {
  const _$LibraryListRequestImpl(
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$LibraryListRequestImpl &&
  ...
  _$$LibraryListRequestImplCopyWith<_$LibraryListRequestImpl> get copyWith =>
      __$$LibraryListRequestImplCopyWithImpl<_$LibraryListRequestImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$LibraryListRequestImplToJson(
      this,
    );
  }
}

abstract class _LibraryListRequest implements LibraryListRequest {
  const factory _LibraryListRequest(
  ...
  factory _LibraryListRequest.fromJson(Map<String, dynamic> json) =
      _$LibraryListRequestImpl.fromJson;
...
LibraryListResponse _$LibraryListResponseFromJson(Map<String, dynamic> json) {
  return _LibraryListResponse.fromJson(json);
}
...
/// @nodoc
abstract class $LibraryListResponseCopyWith<$Res> {
  factory $LibraryListResponseCopyWith(
          LibraryListResponse value, $Res Function(LibraryListResponse) then) =
      _$LibraryListResponseCopyWithImpl<$Res, LibraryListResponse>;
  @useResult
  $Res call(
      {@JsonKey(name: "libraryVideosData")
...
/// @nodoc
class _$LibraryListResponseCopyWithImpl<$Res, $Val extends LibraryListResponse>
    implements $LibraryListResponseCopyWith<$Res> {
  _$LibraryListResponseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$LibraryListResponseImplCopyWith<$Res>
    implements $LibraryListResponseCopyWith<$Res> {
  factory _$$LibraryListResponseImplCopyWith(_$LibraryListResponseImpl value,
          $Res Function(_$LibraryListResponseImpl) then) =
      __$$LibraryListResponseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: "libraryVideosData")
...
/// @nodoc
class __$$LibraryListResponseImplCopyWithImpl<$Res>
    extends _$LibraryListResponseCopyWithImpl<$Res, _$LibraryListResponseImpl>
    implements _$$LibraryListResponseImplCopyWith<$Res> {
  __$$LibraryListResponseImplCopyWithImpl(_$LibraryListResponseImpl _value,
  ...
  $Res call({
    ...
    return _then(_$LibraryListResponseImpl(
      libraryVideosData: freezed == libraryVideosData
...
/// @nodoc
@JsonSerializable()
class _$LibraryListResponseImpl implements _LibraryListResponse {
  const _$LibraryListResponseImpl(
      {@JsonKey(name: "libraryVideosData")
      final List<LibraryVideosDatum>? libraryVideosData})
      : _libraryVideosData = libraryVideosData;

  factory _$LibraryListResponseImpl.fromJson(Map<String, dynamic> json) =>
      _$$LibraryListResponseImplFromJson(json);
  ...
  @override
  String toString() {
    return 'LibraryListResponse(libraryVideosData: $libraryVideosData)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$LibraryListResponseImpl &&
            const DeepCollectionEquality()
  ...
  _$$LibraryListResponseImplCopyWith<_$LibraryListResponseImpl> get copyWith =>
      __$$LibraryListResponseImplCopyWithImpl<_$LibraryListResponseImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$LibraryListResponseImplToJson(
      this,
    );
  }
}

abstract class _LibraryListResponse implements LibraryListResponse {
  const factory _LibraryListResponse(
          {@JsonKey(name: "libraryVideosData")
          final List<LibraryVideosDatum>? libraryVideosData}) =
      _$LibraryListResponseImpl;

  factory _LibraryListResponse.fromJson(Map<String, dynamic> json) =
      _$LibraryListResponseImpl.fromJson;

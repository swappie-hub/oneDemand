...
class _$VideoDetailResponseImpl implements _VideoDetailResponse {
  ...
  @override
  String toString() {
    return 'VideoDetailResponse(id: $id, vId: $vId, title: $title, description: $description, categoryId: $categoryId, videoLevel: $videoLevel, videoId: $videoId, tags: $tags, products: $products, createdAt: $createdAt, videolink: $videolink, thumnailLink: $thumnailLink, duration: $duration, releaseDateTime: $releaseDateTime, isFeatured: $isFeatured, v: $v, updatedAt: $updatedAt, categoryDetails: $categoryDetails, tagsDetails: $tagsDetails, productsData: $productsData, savedvideo: $savedvideo)';
  }
...
abstract class _VideoDetailResponse implements VideoDetailResponse {
  const factory _VideoDetailResponse(
      ...
      @JsonKey(name: "productsData") final List<ProductsDatum>? productsData,
      @JsonKey(name: "savedvideo")
      final bool? savedvideo}) = _$VideoDetailResponseImpl;
